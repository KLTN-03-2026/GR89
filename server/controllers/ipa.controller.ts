...
export class IpaController {
  ...
  static exportIpaData = CatchAsyncError(
  ...
  static importIpaJson = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  static updateManyIpaStatus = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  // (ADMIN) Xóa nhiều IPA
  static deleteManyIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { ids } = req.body
      if (!ids || !Array.isArray(ids) || ids.length === 0) {
        return next(new ErrorHandler('Danh sách ID không được để trống', 400))
  ...
  static assessPronunciationIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { referenceText, ipaId } = req.body
      ...
      if (!audioFile || !audioFile.buffer || audioFile.buffer.length === 0)
        return next(new ErrorHandler('Ghi âm không hợp lệ, vui lòng thử lại', 400))
  ...
  static saveHighestScore = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  static getHighestScore = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const user = req.user as UserInfo
      const { lessonId } = req.params
  ...
  static getOverviewStats = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
  ...
  static createIpa = CatchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const newIpa = await IpaService.createIpa({
      sound,
      soundType,
      image,
      video,
  ...
  static updateIpa = CatchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
    ...
    const updatedIpa = await IpaService.updateIpa(id, {
      sound,
      soundType,
      image,
      video,
  ...
  static updateIpaStatus = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static toggleVipStatus = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static addExampleIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static updateExampleIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static deleteExampleIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static deleteManyExamplesIpa = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
  ...
  static swapOrderIndex = CatchAsyncError(
    async (req: Request, res: Response, next: NextFunction) => {
      const { id } = req.params
