...
interface Props {
  ...
  urlSortBy: WritingSortField
  urlSortOrder: WritingSortOrder
  urlLimit: number
...
export default function FiltersPanel({ urlIsActive, urlSortBy, urlSortOrder, urlLimit, updateUrl, search, setSearch, handleSearch, activeFiltersCount, setShowFilters, writingsLength, total }: Props) {
  ...
  const handleSortOrder = (order: WritingSortOrder) => {
    ...
    <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={urlSortBy} onValueChange={(value: WritingSortField) => handleSort(value)}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="space-y-2">
          ...
          <Select value={urlSortOrder} onValueChange={(value: WritingSortOrder) => handleSortOrder(value)}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t">
        ...
        <div className="text-sm text-gray-500">
          Hiển thị {writingsLength} trong {total} kết quả
        </div>
      </div>
    </div>
  )
