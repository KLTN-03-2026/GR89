...
export function CardPreview({ variant = 'default' }: { variant?: 'default' | 'compact' }) {
  if (variant === 'compact') {
    return (
      <div className="aspect-5/3 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center mb-3">
  ...
  return (
    <div className="aspect-5/3 rounded-1.5rem bg-linear-to-br from-blue-50 to-indigo-50/50 flex items-center justify-center mb-2 group-hover:scale-105 transition-transform duration-700 relative overflow-hidden">
