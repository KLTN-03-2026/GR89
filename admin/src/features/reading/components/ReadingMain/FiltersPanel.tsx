...
export default function FiltersPanel({ urlIsActive, urlSortBy, urlSortOrder, urlLimit, updateUrl, search, setSearch, handleSearch, activeFiltersCount, setShowFilters, readingsLength, total }: Props) {
    ...
    <div className="mb-6 p-4 bg-gray-50 rounded-lg border">
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t">
        ...
        <div className="text-sm text-gray-500">
          Hiển thị {readingsLength} trong {total} kết quả
        </div>
      </div>
    </div>
  )
