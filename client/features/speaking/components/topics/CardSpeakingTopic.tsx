...
interface CardSpeakingTopicProps {
  topic: Speaking;
}
  ...
  return (
    <Popover>
      <PopoverTrigger className='w-full text-center group'>
        <Card className='relative flex flex-col h-full justify-between transition-all duration-500 ease-out p-6 bg-white border-2 border-orange-300 shadow-xl hover:shadow-2xl hover:scale-105 overflow-hidden'>
          ...
          <CardContent className="p-0">
            <CardTitle className='font-bold text-lg mb-2 transition-all duration-300 text-gray-800 group-hover:text-orange-600'>{topic.title}</CardTitle>
          ...
          <CardFooter className="p-0 space-y-3 flex flex-col">
            <Progress value={topic.progress} className=" bg-orange-100! [&>div]:bg-orange-500!" />

            <div className="flex justify-between text-xs w-full">
              <span className="text-gray-600">Tiến độ nói</span>
