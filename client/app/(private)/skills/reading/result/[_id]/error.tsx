...
interface ReadingResultErrorProps {
  error: Error & { digest?: string }
  reset: () => void
}

export default function ReadingResultError({ error, reset }: ReadingResultErrorProps) {
  ...
  const getErrorMessage = () => {
    ...
    if (errorMessage.includes('404')) {
      return 'Không tìm thấy kết quả bài đọc. Vui lòng làm lại bài và thử lại.'
    }
    ...
    return 'Đã xảy ra lỗi khi tải trang kết quả reading. Vui lòng thử lại.'
  }
  ...
  return (
    <ContentStateDisplay
      type={type}
      title="Không thể tải kết quả Reading"
      ...
      actions={[
        {
          label: 'Quay về danh sách Reading',
          onClick: () => {
