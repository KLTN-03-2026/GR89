...
interface ReadingLessonErrorProps {
  error: Error & { digest?: string }
  reset: () => void
}

export default function ReadingLessonError({ error, reset }: ReadingLessonErrorProps) {
  ...
  const getErrorMessage = () => {
    ...
    if (errorMessage.includes('404')) {
      return 'Không tìm thấy bài đọc. Vui lòng quay lại danh sách và thử bài khác.'
    }
    ...
    return 'Đã xảy ra lỗi khi tải bài reading. Vui lòng thử lại.'
  }
