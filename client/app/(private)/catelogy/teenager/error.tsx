...
export default function TeenagerCatelogyError({ error, reset }: ErrorProps) {
  ...
  const getErrorMessage = () => {
    ...
    return 'Đã xảy ra lỗi khi tải danh mục. Vui lòng thử lại.'
  }
  ...
  return (
    <ContentStateDisplay
      type={type}
      title="Không thể tải danh mục Teenager"
