...
export default function TeenagerClassDetailError({ error, reset }: ErrorProps) {
  ...
  return (
    <ContentStateDisplay
      ...
      onRetry={handleRetry}
      showBackButton={true}
      backUrl="/catelogy/teenager"
      actions={[
        {
          label: 'Quay lại danh mục Teenager',
          onClick: () => {
            window.location.href = '/catelogy/teenager'
          },
          variant: 'default',
        },
      ]}
