...
export default function KidsClassDetailError({ error, reset }: ErrorProps) {
  ...
  return (
    <ContentStateDisplay
      ...
      onRetry={handleRetry}
      showBackButton={true}
      backUrl="/catelogy/kids"
      actions={[
        {
          label: 'Quay lại danh mục Kids',
          onClick: () => {
            window.location.href = '/catelogy/kids'
          },
          variant: 'default',
        },
      ]}
