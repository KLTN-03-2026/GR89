  ...
  return (
    <>
      <section className="mb-5">
        <div className={`flex items-center gap-4 justify-between w-full rounded-2xl px-8 py-12 bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-200`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.from({ length: 6 }).map((_, index) => (
            ...
            >
              ...
              <div className="w-full h-32 bg-orange-100 dark:bg-orange-900/30 rounded-lg"></div>
